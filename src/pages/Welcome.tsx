  ...
  return (
    <div className="relative min-h-screen bg-[#750015] text-white lg:flex">
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-8 sm:px-10 lg:px-16">
        <div className="w-full max-w-xl rounded-[2rem] bg-[#750015] p-2 shadow-xl shadow-slate-900/5 sm:p-8 lg:rounded-[2.5rem] lg:p-10">
          ...
          <div className="mt-10 space-y-4 text-center sm:text-left">
            ...
            <h2 className="text-4xl font-bold tracking-tight sm:text-5xl">
              Workspace for Universities
            </h2>
            <p className="max-w-lg text-base leading-5 text-white">
              Coordinate classes, communication, resources, assessments, and academic life in one structured environment.
              </p>
          </div>
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            ...
            >
              ...
              type="button"
              onClick={onLogin}
              className="inline-flex flex-1 items-center justify-center rounded-xl bg-[#750015] px-5 py-3 text-sm font-semibold text-white shadow-lg shadow-[#750015]/20 transition hover:bg-[#5d0011] border"
            >
              Join Workspace
            </button>
          </div>
