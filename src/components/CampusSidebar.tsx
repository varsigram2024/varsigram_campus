...
export const CampusSidebar = ({ currentPage, onPageChange, onAIChatClick }: CampusSidebarProps) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`flex justify-between fixed left-0 top-0 h-screen w-64 transform bg-white shadow-xl transition-transform duration-300 ease-in-out z-40 lg:relative lg:transform-none ${
